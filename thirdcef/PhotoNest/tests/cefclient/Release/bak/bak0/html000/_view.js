...
function addto() {
    ...
    if (_readonly != "0") {
        ...
        $.colorbox({
            transition: "none", width: 485, height: 300, fixed: true, iframe: true, overlayClose: false, opacity: .7,
            title: _tit10,
            href: function () {
...
$(document).ready(function () {
    ...
    $("a.del_box").colorbox({
        transition: "none", width: 485, height: 300, fixed: true, iframe: true, overlayClose: false, opacity: .6, closeButton: false,
        //   title: _tit20,
        onComplete: function () {
