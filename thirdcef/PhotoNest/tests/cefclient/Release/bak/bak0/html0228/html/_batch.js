...
$(document).ready(function () {
    ...
    $.getJSON('./ws.php?method=batch.slider', function (data) {
        ...
        if (data.stat == "ok") {
            ...
            $("#s_postdate").html(data.result.slider_postdate);
            $("#s_filesize").html(data.result.slider_filesize);
            $("#s_createdate").html(data.result.slider_createdate);
            ...
            $('[data-slider=createdates]').dblSlider(sliders.createdates);
            $('[data-slider=postdates]').dblSlider(sliders.postdates);
        }
    });
    ...
    $("a.preview-box").colorbox({
        transition: "none", width: "85%", height: "85%", className: 'zz', maxWidth: 1140,
        onComplete: function () {
            _dp = 1;
        },
        onClosed: function () {
