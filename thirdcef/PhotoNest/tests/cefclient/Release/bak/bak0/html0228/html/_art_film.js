...
function playmp4() {
    if (_blob) {
        $.colorbox({
            transition: "none", width: "95%", height: "95%", fixed: true, iframe: false,
            html: '<div class="vdobox"><video id="vdo" disablepictureinpicture="true" controls="controls" autoplay="autoplay" style="vertical-align: middle;max-width: 100%;background-color:black;max-height: 100%; "><source src="' + URL.createObjectURL(_blob) + '" type="video/webm"> </video></div>',
            onComplete: function () {
...
function save_art() {
    ...
    $.colorbox({
        transition: "none", width: 457, height: 280, fixed: true, iframe: true, overlayClose: false,
        title: _tit20,
        href: function () {
