;(function(window){function Progress(target,{size=10,val=0,precision=0,getVal=()=>{},drag=true,direction='horizontal',tip=false}={}){if(!target)return 
...
if(typeof tip==='object'){this.tip=tip||{trigger:'show',align:'top'}}else if(typeof tip!='boolean'){return }
this.initialize()}
...
btnLoading.style.height=btnTip.offsetHeight+'px'},onLoad:function(e,callback=()=>{}){if(typeof e!=='boolean')return 
