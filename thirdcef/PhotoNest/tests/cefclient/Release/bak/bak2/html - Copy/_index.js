...
$(document).ready(function () {
    ...
    //		<img src="public/_thumb/galleries_4/v2-7e1be0661abfdc80467628eb48caffea_r.jpg" style="display:none;" onload="aaa(this);"/>
    if (_last == "1") {
        setTimeout(function () {
    ...
    var sbFunc = function (link, box) {
        $(link).click(function () {
            ...
            var left = Math.min($(this).position().left, $(window).width() - w0);
